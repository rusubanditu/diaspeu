        ...
        <div className="max-w-6xl mx-auto relative z-10">
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-center">
            ...
            <div className="animate-fade-in order-2 lg:order-1">
              ...
              {/* Social Media Links */}
              <h3 className="text-2xl font-semibold text-orange-800 mb-6 text-center pt-5">
                Apasă pe butoanele de mai jos pentru a te alătura comunității
                noastre
              </h3>
              <div className="grid grid-cols-3 sm:grid-cols-5 gap-4 mt-8">
                <Link
                  href="https://www.facebook.com/profile.php?id=61578082146140"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 text-orange-600 bg-white/80 backdrop-blur-sm rounded-lg p-3 hover:bg-orange-100 transition-colors"
                >
                ...
                <Link
                  href="https://www.facebook.com/groups/diasporaeude/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 text-orange-600 bg-white/80 backdrop-blur-sm rounded-lg p-3 hover:bg-orange-100 transition-colors"
                >
                ...
                <Link
                  href="https://chat.whatsapp.com/Ll9mu2s0zNnDbnpiL6vPcx"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 text-orange-600 bg-white/80 backdrop-blur-sm rounded-lg p-3 hover:bg-orange-100 transition-colors"
                >
                ...
                <Link
                  href="https://www.instagram.com/diasporaeu1/"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 text-orange-600 bg-white/80 backdrop-blur-sm rounded-lg p-3 hover:bg-orange-100 transition-colors"
                >
                ...
                <Link
                  href="https://t.me/+J1jB4RhqSmI3MzU0"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex items-center justify-center gap-2 text-orange-600 bg-white/80 backdrop-blur-sm rounded-lg p-3 hover:bg-orange-100 transition-colors"
                >
